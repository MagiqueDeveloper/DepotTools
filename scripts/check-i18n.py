...
RES_DIR = os.path.join("src", "DepotToolsGui", "Resources")
...
PENDING_TRANSLATION: set[str] = {
    ...
    "Add_Downloading",
    "Add_Status_ContactingServer",
    "Add_Status_FindingManifest",
    "Add_Status_DownloadingManifest",
    "Settings_AppUpdateNotifications",
