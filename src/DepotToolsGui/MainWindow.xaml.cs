...
public partial class MainWindow : Wpf.Ui.Controls.FluentWindow
{
    ...
    {
        _trayIcon = new System.Windows.Forms.NotifyIcon { Text = "DepotTools", Visible = false };
        try
        {
        ...
        menu.Items.Add(DepotToolsGui.Resources.Strings.Tray_Open, null, (_, _) => RestoreFromTray());
        menu.Items.Add(new System.Windows.Forms.ToolStripSeparator());
        menu.Items.Add(DepotToolsGui.Resources.Strings.Tray_Exit, null, (_, _) => ExitApp());
    ...
    /// <summary>Launch tray-only for a headless install (depottools://install/silent/&lt;id&gt;): show the tray
