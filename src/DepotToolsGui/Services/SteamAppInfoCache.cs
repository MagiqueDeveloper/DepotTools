...
public class SteamAppInfoCache
{
    ...
    /// appdetails. Replacing the old DepotBox/api/steam/details proxy, which was just this endpoint with
    ...
    /// the DepotBox proxy did). Null if not cached, delisted ("{}"), or nameless.</summary>
