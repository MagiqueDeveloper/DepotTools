...
/// <param name="Tags">
/// The fixes' categories as the listing names them ("Online Fix", "Bypass", …). Worth showing,
/// because the endpoint is called "denuvo" but the listing is overwhelmingly not: of the games it
/// returns, most are Online Fixes and no tag named "Denuvo" exists at all.
/// </param>
...
/// </para>
/// </summary>
public class FixLookupService(DepotBoxService api)
{
