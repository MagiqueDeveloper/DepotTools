...
/// <code>
/// %AppData%\DepotToolsGui\luavault\&lt;appid&gt;\index.json
/// %AppData%\DepotToolsGui\luavault\&lt;appid&gt;\&lt;sha256&gt;.lua
/// </code>
...
public class LuaVault
{
    private static readonly string DefaultRoot = Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "DepotToolsGui", "luavault");
