...
DepotTools is translated into 29 languages (full parity with Steam's supported languages). Help improve or
...
2. **Don't translate these.** Leave them as-is:
   - Product names: **SteamTools**, **OpenSteamTools**, **CloudRedirect**, **Steam**, **Discord**, **DepotBox**.
