...
{
    private readonly DepotBoxService api;
    ...
    public FixesViewModel(
        DepotBoxService api, AuthService auth, LuaInstaller installer, SteamService steam,
    ...
    /// Used by the depottools://fix/ protocol handler.
    /// </summary>
